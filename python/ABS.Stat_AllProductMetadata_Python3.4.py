...
try:
    #result = client.service.GetDataStructureDefinition(__inject={'msg': Queries.messageGetDataStructureDefinitionPerProduct})

    assert(Queries.messageGetDataStructureDefinitionAllProducts is not None)
    print(Queries.messageGetDataStructureDefinitionAllProducts)
    print("Let's go...")
    message = byte_str_class(Queries.messageGetDataStructureDefinitionAllProducts, 'utf-8')

    rawResultGetDataStructure = client.service.GetDataStructureDefinition(__inject={'msg': message}, retxml=True)
