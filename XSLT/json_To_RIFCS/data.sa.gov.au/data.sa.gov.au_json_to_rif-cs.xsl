...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_originatingSource" select="'http://data.sa.gov.au'"/>
    <xsl:param name="global_baseURI" select="'http://data.sa.gov.au/'"/>
    <xsl:param name="global_group" select="'data.sa.gov.au'"/>
    <xsl:param name="global_contributor" select="'data.sa.gov.au'"/>
    <xsl:param name="global_publisherName" select="'data.sa.gov.au'"/>
    <xsl:param name="global_publisherPlace" select="'South Australia'"/>
