...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="global_group" select="'catalogue.beta.data.wa.gov.au'"/>
    <xsl:param name="global_contributor" select="'catalogue.beta.data.wa.gov.au'"/>
    <xsl:param name="global_publisherName" select="'catalogue.beta.data.wa.gov.au'"/>
    <xsl:param name="global_publisherPlace" select="'Western Australia'"/>
