...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_originatingSource" select="'QSpatial - Queensland Spatial Data Catalogue'"/> <!-- Only used as originating source if organisation name cannot be determined from Point Of Contact -->
    <xsl:param name="global_group" select="'QSpatial - Queensland Spatial Data Catalogue'"/> 
    <xsl:param name="global_baseURI" select="'QSpatial.ga.gov.au'"/>
   ...
   <xsl:template match="*:MD_TopicCategoryCode" mode="registryObject_subject">
    ...
    <xsl:template name="registryObject_citationMetadata_citationInfo">
        ...
        <!-- We can only accept one DOI; howerver, first we will QSpatial all -->
   ...
   <xsl:function name="custom:getRegistryObjectTypeSubType" as="xs:string*">
    ...
    <!-- QSpatials name of organisation with particular role - ignores organisations that have an individual name -->
