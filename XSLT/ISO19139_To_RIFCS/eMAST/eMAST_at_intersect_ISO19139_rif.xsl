...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_originatingSource" select="'Ecosystem Modelling and Scaling Infrastructure (eMAST) Facility'"/> <!-- Only used as originating source if organisation name cannot be determined from Point Of Contact -->
    <xsl:param name="global_group" select="'Macquarie University, Australia'"/> 
    <xsl:param name="global_baseURI" select="'rdsi-emast1-vm.intersect.org.au:8080'"/>
