...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="gmd:MD_TopicCategoryCode" mode="IMOS_registryObject_subject">
    ...
    <xsl:template match="*:MD_CreativeCommonss" mode="IMOS_registryObject_rights_licence_creative">
    ...
    <xsl:template match="*:MD_CreativeCommonss" mode="IMOS_registryObject_rights_rightsStatement_creative">
