...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="global_baseURI" select="'mest.aodn.org.au:80'"/>
    <xsl:param name="global_group" select="'Australian Ocean Data Network'"/>
    <xsl:param name="global_groupAcronym" select="'AODN'"/>
    ...
    <xsl:template match="mcp:MD_Metadata">
        ...
        <xsl:variable name="pointOfContactNode_sequence" as="node()*">
            <xsl:if test="count(gmd:identificationInfo[1]/mcp:MD_DataIdentification) > 0">
                <xsl:copy-of select="custom:getPointOfContactSequence(gmd:identificationInfo[1]/mcp:MD_DataIdentification)"/>
            </xsl:if>
            
            <xsl:if test="count(gmd:identificationInfo[1]/mcp:MD_ServiceIdentification) > 0">
                <xsl:copy-of select="custom:getPointOfContactSequence(gmd:identificationInfo[1]/mcp:MD_ServiceIdentification)"/>
            </xsl:if>
            
            <xsl:if test="count(gmd:identificationInfo[1]/srv:SV_ServiceIdentification) > 0">
                <xsl:copy-of select="custom:getPointOfContactSequence(gmd:identificationInfo[1]/srv:SV_ServiceIdentification)"/>
            </xsl:if>
        ...
        <xsl:variable name="citationContributorIndividualName_specificRole_sequence" as="xs:string*">
            <!--xsl:message select="concat('count gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation: ', count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation))"/-->
            <xsl:if test="count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation) > 0">
                <xsl:copy-of select="custom:getIndividualNameSequence(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation, 'principalInvestigator,author,coInvestigator')"/> 
            </xsl:if>
        </xsl:variable>
        ...
        <xsl:variable name="citationContributorOrganisationNameNoIndividualName_specificRole_sequence" as="xs:string*">
            <xsl:if test="count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation) > 0">
                <xsl:copy-of select="custom:getOrganisationNameSequence(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation, 'principalInvestigator,author,coInvestigator')"/>    
            </xsl:if>
        </xsl:variable>
        ...
        <xsl:variable name="citationContributorIndividualName_anyRole_sequence" as="xs:string*">
            <!--xsl:message select="concat('count gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation: ', count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation))"/-->
            <xsl:if test="count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation) > 0">
                <xsl:copy-of select="custom:getIndividualNameSequence(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation, ',')"/> 
            </xsl:if>
        </xsl:variable>
        ...
        <xsl:variable name="citationContributorAllOrganisation_anyRole_sequence" as="xs:string*">
            <xsl:if test="count(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation) > 0">
                <xsl:copy-of select="custom:getAllOrganisationNameSequence(gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation, ',')"/>
            </xsl:if>
        </xsl:variable>
        ...
        <registryObject>
            ...
            <xsl:if test="(count($registryObjectTypeSubType_sequence) = 2)">
                <xsl:element name="{$registryObjectTypeSubType_sequence[1]}">
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation/gmd:title"
                        mode="registryObject_name"/>
                    
                    <xsl:if test="$registryObjectTypeSubType_sequence[1] = 'collection'">
                        <xsl:apply-templates
                            select="gmd:identificationInfo[1]/*:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date"
                    ...
                    <xsl:for-each-group
                        select="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty[(string-length(normalize-space(gmd:individualName)) > 0) and 
                    ...
                    <xsl:for-each-group
                        select="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty[(string-length(normalize-space(gmd:organisationName)) > 0) and 
                         (string-length(normalize-space(gmd:role/gmd:CI_RoleCode/@codeListValue)) > 0)] |
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:topicCategory/gmd:MD_TopicCategoryCode"
                        mode="registryObject_subject"/>

                    <xsl:apply-templates select="gmd:identificationInfo[1]/mcp:MD_DataIdentification"
                        mode="registryObject_subject"/>

                    <xsl:apply-templates select="gmd:identificationInfo[1]/srv:ServiceIdentification"
                        mode="registryObject_subject"/>

                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/mcp:MD_ServiceIdentification"
                        mode="registryObject_subject"/>

                    <xsl:apply-templates select="gmd:identificationInfo[1]/*/gmd:abstract"
                        mode="registryObject_description"/>

                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox"
                        mode="registryObject_coverage_spatial">
                        <xsl:with-param name="code" select="$projectionCode"/>
                    </xsl:apply-templates>

                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_BoundingPolygon/gmd:polygon"
                        mode="registryObject_coverage_spatial"/>
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/srv:SV_ServiceIdentification/srv:operatesOn"
                        mode="registryObject_relatedInfo"/>

                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:resourceConstraints/mcp:MD_CreativeCommons[
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:resourceConstraints/mcp:MD_Commons[
                            exists(mcp:licenseLink)]"
                        mode="registryObject_rights_licence_creative"/>
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:resourceConstraints/gmd:MD_LegalConstraints"
                    ...
                    <xsl:apply-templates
                        select="gmd:identificationInfo[1]/*/gmd:resourceConstraints/gmd:MD_Constraints"
                        mode="registryObject_rights_rightsStatement"/>
                    ...
                    <xsl:if test="$registryObjectTypeSubType_sequence[1] = 'collection'">
                       ...
                       <xsl:for-each select="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation">
    ...
    <xsl:template match="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation/gmd:title"
        mode="registryObject_name">
    ...
    <xsl:template match="gmd:identificationInfo[1]/*/gmd:citation/gmd:CI_Citation/gmd:date"
        mode="registryObject_dates">
    ...
    <!-- RegistryObject - Coverage Spatial Element -->
    <xsl:template match="gmd:EX_BoundingPolygon/gmd:polygon" mode="registryObject_coverage_spatial">
        <xsl:if
